...
class TestMecha(TestCase):
    def test_cook_finite_strain_voce_isotropic_hardening(self):
        ...
        # stabilization_parameter = 0.05 * parameters["YoungModulus"] / (1.0 + parameters["PoissonRatio"])
        # stabilization_parameter = 0.02 * parameters["YoungModulus"] / (1.0 + parameters["PoissonRatio"])
