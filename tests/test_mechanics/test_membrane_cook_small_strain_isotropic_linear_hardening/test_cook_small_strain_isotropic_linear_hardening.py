...
class TestMecha(TestCase):
    def test_cook_small_strain_linear_isotropic_hardening(self):
        ...
        F_min= 0
        F_max= 1800/0.016 # 1.8 knewton/0.016 m2 (Pascal)
        ...
        # --- MATERIAL
        parameters = {"YoungModulus": 70e6, "PoissonRatio": 0.4999, "HardeningSlope": 0.135e6, "YieldStress": 0.243e6}
        ...
        mat = Material(
            ...
            library_name="SmallStrainIsotropicLinearHardeningPlasticity",
